...
from old_scripts.kerasformain import plot_cm, evaluate_metrics
...
from old_scripts.kerasformain import prephybrid
import time
...
def main(data_path, descriptor_path, embedding_model, ds_name):
    ...
    (
        ...
        n_num,
        n_cat,
    ) = prephybrid(X_train, X_test, y_train, y_test, binsize=10)
