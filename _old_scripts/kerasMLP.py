...
import numpy as np
from old_scripts.draft_scripts.preprocessing import MLPpreprocessing_pipeline_onehot
...
def make_MLP(
    xdim, metrics=METRICS, output_bias=None,
):
...
plot_roc(
    "Test Baseline", y_test, test_predictions_baseline, color=colors[0], linestyle="--"
)
...
plot_roc(
    "Test Weighted", y_test, test_predictions_weighted, color=colors[1], linestyle="--"
)
